"""Defines all commands and events for the discordbot"""
import discord
from discord import Embed, Colour, Interaction, Object
from discord.app_commands.errors import MissingRole, MissingAnyRole
from discord.member import Member
from discord.ext.commands import Bot

import modules.config as cfg
from modules.views.explain_embed_view import ExplainEmbedView
import modules.command_logic as cl
from modules.util import command_error_embed_gen
from modules.database import get_session, Player
from modules.exceptions import MyException


def init(bot: Bot) -> None:
    guilds = []
    for guild_id in cfg.GUILD_IDS:
        guilds.append(Object(id = guild_id))
